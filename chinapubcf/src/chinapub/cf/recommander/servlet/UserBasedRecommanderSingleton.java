 ...
 */
public final class UserBasedRecommanderSingleton {

	  private final Recommender recommender;
	
	  private static UserBasedRecommanderSingleton instance;
	
	  public static synchronized UserBasedRecommanderSingleton getInstance() {
	    if (instance == null) {
	  ...
	  public static synchronized void initializeIfNeeded(String recommenderClassName) throws TasteException {
	    if (instance == null) {
	      instance = new UserBasedRecommanderSingleton(recommenderClassName);
	    }
	  }
