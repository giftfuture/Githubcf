 ...
 */
public final class ItemBasedRecommanderSingleton {

	  private final Recommender recommender;
	
	  private static ItemBasedRecommanderSingleton instance;
	
	  public static synchronized ItemBasedRecommanderSingleton getInstance() {
	    if (instance == null) {
	  ...
	  public static synchronized void initializeIfNeeded(String recommenderClassName) throws TasteException {
	    if (instance == null) {
	      instance = new ItemBasedRecommanderSingleton(recommenderClassName);
	    }
	  }
