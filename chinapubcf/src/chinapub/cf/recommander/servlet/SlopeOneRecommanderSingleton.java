 ...
 */
public final class SlopeOneRecommanderSingleton {

	  private final Recommender recommender;
	
	  private static SlopeOneRecommanderSingleton instance;
	
	  public static synchronized SlopeOneRecommanderSingleton getInstance() {
	    if (instance == null) {
	  ...
	  public static synchronized void initializeIfNeeded(String recommenderClassName) throws TasteException {
	    if (instance == null) {
	      instance = new SlopeOneRecommanderSingleton(recommenderClassName);
	    }
	  }
